...
class StudentService:
    ...
    @staticmethod  # get all student with minimal data for marks entry
    async def get_all_student_with_minimal_data(
        db: AsyncSession,
            ...
            if search:
                query = query.where(
                    or_(
                        ...
                        Student.registration.ilike(f"%{search}%"),
